...
#. Pull the code - ``git clone git@github.com:nprapps/cash-register-justice-master``
#. Enter the project folder - ``cd cash-register-justice-master``
